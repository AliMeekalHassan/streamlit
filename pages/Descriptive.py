...
st.markdown("<h1 style='text-align: center;'>🧾 Descriptive Statistics</h1>", unsafe_allow_html=True)   # Titles & Styling
st.markdown("""
    <style>
...
# Box Plot
st.markdown("<h1 style='text-align: center;'>📦 Box Plot</h1>", unsafe_allow_html=True)   # Titles & Styling
